...
Assert-Website ($index -match 'class="liquid-track"' -and $styles -match '@keyframes liquid-lobe') "animated proof progress bars are missing"
...
Assert-Website ($index -match '2026-06-14-hierarchy-v1' -and $technical -match '2026-06-13-p4') "explicit cache version is missing"
Assert-Website ($index -match 'Three Levels' -and $index -match 'InFlux Ecosystem') "updated section hierarchy labels are missing"
